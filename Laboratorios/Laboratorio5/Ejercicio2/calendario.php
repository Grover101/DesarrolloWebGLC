...
?>
<table cellpadding="0" cellspacing="2" width="200" class="table" style="text-align: center;">
    <tr>
        <?php echo '<th bgstyle="color:#4069B1" scope="col">' . $nommes[$mes - 1] . ' ' . $anio . '</th>'; ?>
    </tr>
</table>
<table cellpadding="0" cellspacing="2" class="table table-primary" width="200" style="text-align: center;">
